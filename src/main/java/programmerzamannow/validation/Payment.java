...
public class Payment {
    ...
    @NotBlank(groups = {CreditCardPaymentGroup.class}, message = "Credit card cannot blank")
    private String creditCard;

    @NotBlank(groups = {VirtualAccountPaymentGroup.class}, message = "Virtual account cannot blank")
